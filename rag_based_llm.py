...
from src.prompts import conversation_prompt, question_category_prompt
from src.references import full_resume, personal, project, soft_skills, others, education, experience
from src.ask_vectordb import AskToVectorDB
from src.config import GPT_MODEL_NAME, TOP_K_MATCHES, EMBEDDING_MODEL_NAME, VECTORDB_PATH
import chromadb
from src.config import VECTORDB_PATH, EMBEDDING_MODEL_NAME, TOP_K_MATCHES
from langchain_openai import ChatOpenAI
from langchain_core.messages import HumanMessage, AIMessage


from src.logging_config import configure_file_logger
...
class Assistant:
    ...
    def get_context_for_question_category(self, question_category:str) -> str:
        ...
        return self.context_category.get(question_category)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        print("Answer -------------------------- :")
        for key, value in ai_response['response'].dict().items():
            print(f"{key}: {value}")
        print("\n")